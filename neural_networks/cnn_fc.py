...
class NeuralNetwork(nn.Module):
    ...
    def forward(self, x, batch_size = 1):
        ...
        x = x.view(batch_size, self.input_size[2], self.input_size[0], self.input_size[1])
...
# dummy = torch.randn([32, 32, 3])
# print(dummy.shape)
# model = NeuralNetwork(input_size = dummy.shape, output_size = 3)

# model.forward(dummy, batch_size = 1)