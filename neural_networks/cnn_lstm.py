...
class NeuralNetwork(nn.Module):
    def __init__(self, input_size = 0, output_size = 0, device = "cpu", lstm_memory = 256):
        ...
        self.conv1 = nn.Conv2d(in_channels = input_size[2], out_channels = 16, kernel_size = 3, stride = 1)
        ...
        self.conv4 = nn.Conv2d(in_channels = 32, out_channels = 64, kernel_size = (5, 2), stride = 1)

        self.lstm_layer1 = nn.LSTM(input_size = 64, hidden_size = self.lstm_memory, num_layers = 1, batch_first = True)

        #self.lstm_layer2 = nn.LSTM(input_size = 2, hidden_size = self.lstm_memory, num_layers = 1, batch_first = True)

        #self.fc1 = nn.Linear(in_features = self.lstm_memory + self.lstm_memory, out_features = 64)
    ...
    def forward(self, x1, x2, batch_size, time_step, hidden_state1, cell_state1, hidden_state2, cell_state2):
        ...
        x1 = x1.view(batch_size, time_step, 64)
